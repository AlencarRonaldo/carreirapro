...
export class EducationService {
  constructor(
    @InjectRepository(EducationEntity) private readonly repo: Repository<EducationEntity>,
  ...
  async create(userId: string, data: Partial<EducationEntity>): Promise<EducationEntity> {
  ...
  async update(userId: string, id: string, data: Partial<EducationEntity>): Promise<EducationEntity> {
