...
export class SkillService {
  constructor(
    @InjectRepository(SkillEntity) private readonly repo: Repository<SkillEntity>,
  ...
  async create(userId: string, data: Partial<SkillEntity>): Promise<SkillEntity> {
  ...
  async update(userId: string, id: string, data: Partial<SkillEntity>): Promise<SkillEntity> {
