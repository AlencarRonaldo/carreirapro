...
let EducationService = class EducationService {
    ...
    async create(userId, data) {
        ...
        if (!profile) {
            profile = await this.profiles.save(this.profiles.create({ id: userId, fullName: '', headline: '' }));
        }
    ...
    async update(userId, id, data) {
        ...
        if (!entity)
            throw new common_1.NotFoundException('Educação não encontrada');
...
exports.EducationService = EducationService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(education_entity_1.EducationEntity)),
