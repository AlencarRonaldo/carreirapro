...
let ExperienceEntity = class ExperienceEntity {
    id;
    title;
    company;
    startDate;
...
__decorate([
    ...
    __metadata("design:type", String)
], ExperienceEntity.prototype, "title", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 255 }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => profile_entity_1.ProfileEntity, (p) => p.experiences, { onDelete: 'CASCADE' }),
    __metadata("design:type", profile_entity_1.ProfileEntity)
], ExperienceEntity.prototype, "profile", void 0);
exports.ExperienceEntity = ExperienceEntity = __decorate([
